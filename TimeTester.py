...
def CompileCpp():
    global CppFile
    if os.system("g++ -Wl,--stack,100000000 -std=c++11 Workshop\\check.cpp -o Workshop\\check.exe") == 1:import osimport os
import threading
import shutil
CppFile = []
isCheck = 0
...
#if you want the line rounded, please add " interpolate='basis' " in "mark.line()"
#like "line = alt.Chart(source).mark_line(interpolate='basis').encode("
